...
private:
    ...
    ID3D12PipelineState* m_pipelineStateLinesOccluded = nullptr;
    ID3D12PipelineState* m_pipelineStateGizmo = nullptr;
    ID3D12PipelineState* m_pipelineStateGizmoOccluded = nullptr;
